...
const AuthProvider = props => {
  ...
  const [loggedInChangeCounter, setLoggedInChangeCounter] = useState(0); // Create a client and register an observer that triggers when the user logs in or out
...
const RequiredAuthProvider = props => {
  ...
  return /*#__PURE__*/React.createElement(AuthProvider, sharedProps, /*#__PURE__*/React.createElement(WrappedComponent, null));
};
...
export { AuthProvider, AuthProviderForTesting, RedirectToLogin, RedirectToSignup, RequiredAuthProvider, loadOrgSelectionFromLocalStorage, saveOrgSelectionToLocalStorage, useAccessHelper, useActiveOrg, useAuthInfo, useHostedPageUrls, useLogoutFunction, useOrgHelper, useRedirectFunctions, withAuthInfo, withRequiredAuthInfo };
